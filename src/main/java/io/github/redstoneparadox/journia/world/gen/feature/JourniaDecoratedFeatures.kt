...
object JourniaDecoratedFeatures {
    ...
    val MUD_PATCH_8: ConfiguredFeature<*, *>
    ...
    init {
        ...
        MUD_PATCH_8 = register("mud_patch_8",
            JourniaConfiguredFeatures.MUD_PATCH.decorate(
                JourniaDecorators.SURFACE_PATCH.configure(LargeCountConfig(8))
            )
        )
        ...
        WETLANDS_MUD_ISLAND = register("wetlands_mud_island",
            JourniaConfiguredFeatures.MUD_ISLAND.decorate(
                ConfiguredFeatures.Decorators.TOP_SOLID_HEIGHTMAP.applyChance(4)
            )
        )
    }
